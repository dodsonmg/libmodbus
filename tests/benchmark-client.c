...
int main(int argc, char *argv[])
{
    ...
    /* Increase the timeout to support benchmarking.  During benchmarking the
     * server will process each request multiple times, so we don't want to
     * timeout while we wait... */
