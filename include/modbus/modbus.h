...
#define MODBUS_FC_READ_STRING 0x18  // added to support macaroons
#define MODBUS_FC_WRITE_STRING 0x19 // added to support macaroons
...
MODBUS_API int modbus_read_bits_build_request(modbus_t *ctx, int addr, int nb, uint8_t *req);
MODBUS_API int modbus_read_bits(modbus_t *ctx, int addr, int nb, uint8_t *dest);
MODBUS_API int modbus_read_input_bits_build_request(modbus_t *ctx, int addr, int nb, uint8_t *req);
MODBUS_API int modbus_read_input_bits(modbus_t *ctx, int addr, int nb, uint8_t *dest);
MODBUS_API int modbus_read_registers_build_request(modbus_t *ctx, int addr, int nb, uint8_t *req);
MODBUS_API int modbus_read_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest);
MODBUS_API int modbus_read_input_registers_build_request(modbus_t *ctx, int addr, int nb, uint8_t *req);
MODBUS_API int modbus_read_input_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest);
MODBUS_API int modbus_write_bit_build_request(modbus_t *ctx, int addr, int status, uint8_t *req);
MODBUS_API int modbus_write_bit(modbus_t *ctx, int coil_addr, int status);
MODBUS_API int modbus_write_register_build_request(modbus_t *ctx, int addr, int value, uint8_t *req);
MODBUS_API int modbus_write_register(modbus_t *ctx, int reg_addr, const uint16_t value);
MODBUS_API int modbus_write_bits_build_request(modbus_t *ctx, int addr, int nb, const uint8_t *src, uint8_t *req);
...
MODBUS_API int modbus_mask_write_register_build_request(modbus_t *ctx, int addr, uint16_t and_mask,
                                                        uint16_t or_mask, uint8_t *req);
MODBUS_API int modbus_mask_write_register(modbus_t *ctx, int addr, uint16_t and_mask, uint16_t or_mask);
MODBUS_API int modbus_write_and_read_registers_build_request(modbus_t *ctx,
...
MODBUS_API int modbus_write_and_read_registers(modbus_t *ctx, int write_addr, int write_nb,
                                               ...
                                               uint16_t *dest);
MODBUS_API int modbus_report_slave_id_build_request(modbus_t *ctx, int max_dest, uint8_t *req);
